    ...
    def createUsers(self, service, users):
        ...
        for aUser in users:
            try:
                ...
                self.log('info', 'Successfully Created User ' + aUser['name.familyName'] + ' ' + aUser['name.givenName'] + ' ' + aUser['email'])
            except:
                self.log('debug', 'Failed to Create User ' + aUser['name.familyName'] + ' ' + aUser['name.givenName'] + ' ' + aUser['email'])
                failed.append(aUser)
        return failed
